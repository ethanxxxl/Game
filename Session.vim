...
nnoremap <F7> :call RunAssembly()
nnoremap <S-F6> :call CompileMakefile():!./run
nnoremap <F6> :call CompileMakefile()
nnoremap <F5> :call RunPython()
map <S-Insert> <MiddleMouse>
...
wincmd w
argglobal
if bufexists('CmdLine.h') | buffer CmdLine.h | else | edit CmdLine.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
