...
// int ParseCmd::getCmd(WINDOW *cmd_line, std::string input, callback_list_type callback_list)
// {
...
std::vector<std::string> ParseCmd::tokenizeString(std::string input_str, char delimeter)
{
...
ParseCmd::token_data ParseCmd::summarizeString(std::string input_str)
{
	// data for the tokenizer
	token_data list;
	std::string word = "";
